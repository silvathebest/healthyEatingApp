...
namespace healthyEatingApp
{
    ...
    {
        readonly string[] questions = new string[]{"Как часто вы завтракаете?",
        ...
        readonly string[] answers = new string[] {"Каждый день","Иногда","Не люблю завтракать",
                                                "Ем их реже чем раз в день","Достаточно много, каждый день их ем","Ем реже чем раз в 3 дня",
                                                ...
                                                "Моя потребность. Организму нужна энергия чтобы функционировать","Удовольствие. Еда делает меня счастливее","Привычка, от которой я не могу отказаться",
        ...
        readonly int[] pointsAnswers = new int[]{2,1,0,
                                        1,2,0,
                                        0,2,1,
                                        2,0,1,
                                        2,0,1,
                                        ...
                                        0,2,1,
                                        2,1,0};
        readonly string[] advices = new string[]{"Министерство здравоохранения РФ сообщает, что правильный завтрак это всегда порция цельнозерновой каши (гречка, овес, рис) и источник белка (яичница, творог или мясо) или яичный омлет с овощами, бутерброд из цельнозернового хлеба с кусочком мяса, как вариант.",
        ...
        readonly string location = Environment.CurrentDirectory;
